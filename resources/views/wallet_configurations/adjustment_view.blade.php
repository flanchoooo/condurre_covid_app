                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                <div class="text-lg-left">
                                    <h1 class="h4 text-gray-900 mb-4">Wallet Adjustments</h1>
                                    <hr>
                                ...
                                <form method="POST" action="/wallet_configurations/adjustment_preauth" aria-label="{{ __('Add Product') }}">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <label for="exampleInputEmail1">Source Account</label>
                                                <input id="mobile" type="text" class="form-control{{ $errors->has('category_name') ? ' is-invalid' : '' }}" name="source_mobile" value="" required autofocus>
                                            </div>


                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <label for="exampleInputEmail1">Destination Account</label>
                                            ...
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                ...
                                                <textarea id="mobile" type="number" class="form-control{{ $errors->has('category_name') ? ' is-invalid' : '' }}" name="narration" value="" required autofocus>
                                                </textarea>
                                            </div>
