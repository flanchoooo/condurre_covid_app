                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <select id="mobile" type="text" class="form-control{{ $errors->has('channel_name') ? ' is-invalid' : '' }}" name="systemName"  required autofocus>
                                                        @foreach($records as $record)
                                                        <option value="{{$record->id}}">{{$record->systemName}}</option>
                                                        @endforeach
                                                    </select>
