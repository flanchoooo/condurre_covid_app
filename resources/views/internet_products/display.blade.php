                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                <div class="text-lg-left">
                                    <h1 class="h4 text-gray-900 mb-4">Internet Banking Products</h1>

                                    <hr>
                                </div>


                                <a href="{{"/internet/products/createview"}}"><label>Create  Product Profile</label> </a> <br>
                                        ...
                                        @foreach($records as $record => $values)
                                            <tr class="odd gradeX">
                                               ...
                                               <td> @php
                                                ...
                                                <td>
                                                    <form role="form" action="/internet/products/id" method="POST">
                                                        @csrf
                                                        ...
                                                        <input type="hidden" class="form-control"  placeholder="Company Name" value="{{$values->status}}"  name="status" >
                                                        <center><button type="submit" class="btn btn-success">Edit</button></center>
                                                    </form>
                                                </td>

                                                <td>
                                                    <form role="form" action="/internet/products/delete" method="POST">
                                                        @csrf
                                                        <input type="hidden" class="form-control"  placeholder="Company Name" value="{{$values->id}}"  name="id" >
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="exampleModalLabel">Confirm Action NB: This will delete associated fee profiles.</h5>
