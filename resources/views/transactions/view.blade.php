                                ...
                                <form method="POST" action="#">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>Interchange Fees {{$rec->interchange_fees}}</label>
                                                </div>
                                            </div>

                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>Zimswitch Fees {{$rec->zimswitch_fee}}</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>Total Credited to Merchant:{{$rec->merchant_account}}</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>MDR:{{$rec->debit_mdr_from_merchant}}</label>
                                                </div>
                                            </div>
