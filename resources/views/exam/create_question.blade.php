                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                ...
                                <form method="POST" action="/exam/creates/questions">
                                    @csrf
                                    <div class="box-body">
                                        <div class="form-group row">
                                            <div class="col-sm-12 mb-3 mb-sm-0">
                                                <div class="form-group">
                                                    ...
                                                    <input id="mobile" type="text" class="form-control{{ $errors->has('category_name') ? ' is-invalid' : '' }}" name="question_text"  required autofocus >
                                                </div>
                                            </div>

                                            <div class="form-group" hidden>
                                                <label for="exampleInputEmail1">Question</label>
                                                <input id="mobile" type="text" class="form-control{{ $errors->has('category_name') ? ' is-invalid' : '' }}" name="exam_id"  value="{{session('id')}}" required autofocus >
                                            </div>
