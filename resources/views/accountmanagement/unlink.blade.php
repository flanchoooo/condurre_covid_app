                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                <div class="text-lg-left">
                                    <h1 class="h4 text-gray-900 mb-4">Unlink Card Profile</h1>
                                ...
                                <form method="POST" action="/accountmanagement/unlinks">
                                    @csrf
                                    <div class="box-body">
                                        ...
                                        <div class="form-group" hidden>
                                            <label for="exampleInputEmail1">Name</label>
                                            <input id="mobile" type="text" class="form-control{{ $errors->has('category_name') ? ' is-invalid' : '' }}" name="unlink" value="{{  'true' }}" required autofocus>
                                        </div>



                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Card Number | PAN</label>
